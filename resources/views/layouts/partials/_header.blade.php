...
@elseif($route == 'detail_menu' || $route == 'cart_detail' || $route == 'payment-method' || $route == 'order_success' || $route == 'detail_order' || $route == 'bill' || $route == 'pay_now' || $route == 'category' || $route == 'request_payment')
